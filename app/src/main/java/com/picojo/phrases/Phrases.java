...
public class Phrases {
    ...
    public static void reset() {
        ...
        //Actions
        phrases.add("le dernier châpeau pointu s'assis par terre pour 8 questions");
        ...
        phrases.add("Règle: Chaque fois que %s dit 'meow', % doit répondre 'moew moew capîtaine' sinon il prend 2 gorgées");
